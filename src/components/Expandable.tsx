...
export function ExpandableCardDemo({ cards }: ExpandableCardDemoProps) {
    ...
    return (
        <>
            ...
            <AnimatePresence>
                {active && typeof active === "object" ? (
                    <div className="fixed inset-0  grid place-items-center z-[99999999999] landscape:max-h-[90vh]">
                        <motion.button
                            ...
                            <div>
                                <div className="flex justify-between items-start p-4">
                                    ...
                                    <motion.a
                                        ...
                                        href={active.ctaLink}
                                        target="_blank"
                                        className="px-4 py-3 text-sm rounded-full font-bold bg-[#de5c00] text-white"
                                    >
                                        {active.ctaText}
                                    </motion.a>
                                </div>
                                    ...
                                    >
                                        {typeof active.content === "function"
                                            ...
                                            : typeof active.content === "string"
                                                ? (active.content as string).substring(0, 350) + '...'
                                                : ''}
                ...
                {cards.map((card) => (
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            className="px-4 py-2 text-sm rounded-full font-bold bg-gray-100 hover:bg-[#de5c00] duration-200 transition-all hover:text-white text-black mt-4 md:mt-0"
                        >
                            {card.ctaText}
                        </motion.button>
                    </motion.div>
